...
export function BlogModal({ post, onClose }: BlogModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden my-8 max-h-[90vh] flex flex-col border border-neutral-100"
      ...
      >
        ...
        <div className="overflow-y-auto p-6 sm:p-10 space-y-6">
          <div className="flex items-center gap-3 text-xs font-normal text-neutral-500">
          ...
          <h1 className="text-2xl sm:text-4xl font-normal text-[#121316] tracking-tight leading-tight">
            {post.title}
          </h1>
          ...
          <div className="flex items-center gap-3 py-3 border-y border-neutral-100">
            ...
            <div>
              ...
              <p className="text-xs text-neutral-500 font-normal">{post.author.role}</p>
            </div>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-neutral-50 border border-neutral-100 mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h4 className="font-normal text-sm text-neutral-900">Have questions about this topic?</h4>
              <p className="text-xs text-neutral-500 font-normal">Our senior property consultants are available for personalized advisory.</p>
            </div>
            <button
              onClick={onClose}
              className="bg-[#121316] text-white text-xs font-normal px-5 py-2.5 rounded-full hover:bg-neutral-800 transition-colors cursor-pointer"
            >
