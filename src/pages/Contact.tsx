    ...
    <div className="min-h-screen bg-white pt-28 sm:pt-32 pb-20 md:pb-28">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 pt-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full text-xs sm:text-sm font-normal bg-[#F3F4F6] text-neutral-900 placeholder:text-neutral-400 rounded-xl p-4 border border-transparent focus:border-neutral-300 focus:bg-[#EAEBED] outline-none transition-all resize-y min-h-[120px]"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#121316] hover:bg-neutral-800 text-white font-normal text-xs sm:text-sm py-3.5 rounded-xl transition-all shadow-sm active:scale-[0.99] cursor-pointer text-center mt-2"
                >
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="bg-[#FBFBFB] rounded-3xl p-6 sm:p-8 border border-neutral-200/80 shadow-xs space-y-6">
              <div>
                <span className="text-[11px] uppercase tracking-widest font-medium text-neutral-500 block mb-1">
              ...
              <div className="space-y-4 text-xs sm:text-sm text-neutral-600 font-normal">
                <div className="flex items-start gap-3.5">
                  <div className="w-9 h-9 rounded-xl bg-[#FDE8D7] text-[#9A3412] flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="leading-relaxed space-y-0.5">
                      <a href="mailto:kpravin2492@gmail.com" className="text-[#121316] hover:underline block">kpravin2492@gmail.com</a>
                      <a href="mailto:careerspravinrealty@gmail.com" className="text-neutral-500 hover:underline block text-xs">Careers: careerspravinrealty@gmail.com</a>
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-2">
                <a
                  ...
                  className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white py-3 px-5 rounded-2xl text-xs sm:text-sm font-normal inline-flex items-center justify-center gap-2.5 shadow-sm transition-all cursor-pointer"
                >
            ...
            {/* Coverage Areas */}
            <div className="bg-white rounded-3xl p-6 border border-neutral-200/80">
              <h4 className="text-xs font-normal uppercase tracking-wider text-neutral-500 mb-3">
